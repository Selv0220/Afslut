...
$buket = $db->sql("SELECT * FROM buket WHERE buId");
?>
...
<div class="row col-10 col-2 p-2 mx-auto my-5 my-lg-3 text-center">
    <?php
    foreach ($buket as $buketter){
        echo "<div class='col-12 col-lg-4'><div class='card' style='width: 18rem;'>
  <img class='card-img-top' <img alt='test' src='images/" . $buketter -> buBillede . "'>
  <div class='card-body'>
    <h5 class='card-title'>" . $buketter -> buNavn . "</h5>
    <p class='card-text'><span>" . $buketter->buBeskrivelse . "</span><span class='prodPris'>" . $buketter -> buPris . "</span></p>
    <a href='linknavn/" . $buketter -> buId . "' class='btn2'>Se detaljer</a>
  </div>
  </div>
</div>";
    }
